							...
							<td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table
									...
									<tr>
										<td height="30" background="Images/mainMenuBg.jpg"
											style="padding-left:25px;">修改楼栋</td>
									</tr>
									<tr>
										<td height="470" align="center" valign="top" bgcolor="#F6F9FE">
											<form	name="form1" method="post"	action="<%=path%>/BuildingUpdateSave?Building_ID=<%=building.getBuilding_ID()%>"	onSubmit="return mycheck()">
												<table width="100%" border="0" cellspacing="0"
													...
													<tr>
														<td height="30" align="right"><span
															style="color:red;">*</span>简介：</td>
														<td><textarea name="Building_Introduction"
																id="Building_Introduction" cols="45" rows="5"><%=building.getBuilding_Introduction()%></textarea></td>
													</tr>
													<tr>
														<td height="30">&nbsp;</td>
