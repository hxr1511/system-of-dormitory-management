          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <td height="200" align="center" valign="top" bgcolor="#F6F9FE">
                      <form name="form1" method="post" action="<%=path%>/StudentTH" onSubmit="return mycheck()" >
<%--                  <tr>--%>
<%--&lt;%&ndash;                    <td width="38%" height="30" align="right">&nbsp;</td>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <td width="62%">&nbsp;</td>&ndash;%&gt;--%>
<%--                  </tr>--%>
                  <tr>
