      ...
      <td height="500" align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="30" background="Images/mainMenuBg.jpg" style="padding-left:25px;">楼栋管理员设置</td>
            </tr>
            <tr>
              ...
              <form name="form1" method="post" action="<%=path%>/TBAddSave">
                <table width="100%%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="42%" height="30" style="padding-left:20px;"> 功能导航： <a href="<%=path%>/BuildingManager">返回上层</a></td>
                    <td width="58%">添加管理员：
...
<%--                  <s:iterator id="aa" value="list">--%>
                  <%for (TBBean tb:tblist){%>
                     <tr align="center">
                      <td height="25" align="center"><%=tb.getTeacher_Name()%></td>
                      <td><%=tb.getTeacher_Sex()%></td>
                      <td><%=tb.getTeacher_Tel()%></td>
                      <td align="center"><%=tb.getTeacher_Username()%></td>
                      <td align="center"><a href="<%=path%>/TBDel?TB_ID=<%=tb.getTB_ID()%>&Building_ID=<%=tb.getTB_BuildingID()%>" onClick="return confirm('确定要将该管理员从该楼栋移除吗？')">移除</a></td>
                    </tr>
                  <%}%>
                </table></td>
            </tr>
