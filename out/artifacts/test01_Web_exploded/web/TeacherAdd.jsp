							...
							<td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table
									...
									<tr>
										<td height="30" background="Images/mainMenuBg.jpg"
											style="padding-left:25px;">添加楼栋管理员</td>
									</tr>
									<tr>
										<td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form
												name="form1" method="post" action="<%=path%>/TeacherAddSave"
												...
												<table width="100%" border="0" cellspacing="0"
													...
													<tr>
														...
														<td><input name="Teacher_Username" type="text"
													...
													<tr>
														...
														<td><input name="Teacher_Password" type="password"
															class="text2" id="Teacher_Password"></td>
													</tr>
													<tr>
														<td height="30" align="right"><span
															style="color:red;">*</span>重复密码：</td>
														<td><input name="Teacher_Password2" type="password"
															class="text2" id="Teacher_Password2"></td>
													</tr>
													<tr>
														<td height="30" align="right"><span
