      ...
      <td height="500" align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="30" background="Images/mainMenuBg.jpg" style="padding-left:25px;">楼栋管理员管理</td>
            </tr>
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE">
                ...
                <table width="100%%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="28%" height="30" style="padding-left:20px;"> 功能导航： <a href="TeacherAdd.jsp">添加楼栋管理员</a></td>
                    <td width="72%">查询：
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr align="center">
                    <td height="25" align="center"><%=teacher.getTeacher_Name()%></td>
                    <td><%=teacher.getTeacher_Sex()%></td>
                    <td><%=teacher.getTeacher_Tel()%></td>
                    <td align="center"><%=teacher.getTeacher_Username()%></td>
                    <td align="center"><a href="TeacherUpdate.jsp?Teacher_ID=<%=teacher.getTeacher_ID()%>">修改</a>
                      <a href="<%=path%>/TeacherDel?Teacher_ID=<%=teacher.getTeacher_ID()%>" onClick="return confirm('确定要删除该楼栋管理员吗？')">删除</a></td>
                  </tr>
                    <%}%>
