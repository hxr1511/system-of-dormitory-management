...
<%@ page import="com.gyk.Dao.TeacherDao" %>
...
<%
	...
	TeacherBean teacher =new TeacherDao().GetTeacherId(Teacher_ID);
							...
							<td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table
									...
									<tr>
										<td height="30" background="Images/mainMenuBg.jpg"
											style="padding-left:25px;">修改楼栋管理员</td>

									</tr>
									<tr>
										<td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form
												name="form1" method="post" action="<%=path%>/TeacherUpdateSave?Teacher_ID=<%=teacher.getTeacher_ID()%>"
												...
												<table width="100%" border="0" cellspacing="0"
													...
													<tr>
														...
														<td>
															<input name="Teacher_Username" type="text"
															class="text2" id="Teacher_Username"
															value="<%=teacher.getTeacher_Username()%>">
														</td>
													</tr>
													<tr>
														<td height="30" align="right">密码：</td>
														<td><input name="Teacher_Password" type="password"
															class="text2" id="Teacher_Password"
													...
													<tr>
														...
														<td><input name="Teacher_Password2" type="password"
													...
													<tr>
														...
														<td><input name="Teacher_Name" type="text"
															class="text2" id="Teacher_Name"
															value="<%=teacher.getTeacher_Name()%>"></td>
													</tr>
													<tr>
														<td height="30" align="right"><span
															style="color:red;">*</span>性别：</td>
														<td>
															<select name="Teacher_Sex" id="Teacher_Sex">
																<option value="">请选择</option>
																<option value="">请选择</option>
																<option value="男"
																		<%if ("男".equals(teacher.getTeacher_Sex())){%>
																		selected
																		<%}%>>男
																</option>
																<option value="女"
																		<%if ("女".equals(teacher.getTeacher_Sex())){%>
																		selected
																		<%}%>>女
																</option>
														</select></td>
													...
													<tr>
														...
														<td><input name="Teacher_Tel" type="text"
															class="text2" id="Teacher_Tel"
															value="<%=teacher.getTeacher_Tel()%>"></td>
													</tr>
													<tr>
														<td height="30">&nbsp;</td>
														<td><input type="submit" name="button" id="button"
															value="修改楼栋管理员"> &nbsp;&nbsp; <input
															type="button" name="button2" id="button2" value="返回上页"
