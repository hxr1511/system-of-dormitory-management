                    ...
                    <tr>
                        ...
                        <td width="709" align="center" valign="top" bgcolor="#F6F9FE">
                            <table width="709" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td height="30" background="Images/mainMenuBg.jpg" style="padding-left:25px;">宿舍管理
                                    </td>
                                </tr>
                                <tr>
                                    <td height="470" align="center" valign="top" bgcolor="#F6F9FE">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="78%">查询：
                                                        <select name="Domitory_BuildingID" id="Domitory_BuildingID">
                                                            ...
                                                            <option value="<%=building.getBuilding_ID()%>"><%=building.getBuilding_Name()%>
                                                            </option>
                                                            <%}%>
                                                        </select>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr align="center">
                                                <td height="25" align="center"><%=domitory.getDomitory_BuildingName()%>
                                                </td>
                                                <td><%=domitory.getDomitory_Name()%>
                                                </td>
                                                <td><%=domitory.getDomitory_Type()%>
                                                </td>
                                                <td align="center"><%=domitory.getDomitory_Number()%>
                                                </td>
                                                <td align="center"><a
                                                        href="DomitoryUpdate.jsp?Domitory_ID=<%=domitory.getDomitory_ID()%>">修改</a>
                                                    <a href="<%=path%>/DomitoryDel?Domitory_ID=<%=domitory.getDomitory_ID()%>"
