                            ...
                            <table width="709" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td height="470" align="center" valign="top" bgcolor="#F6F9FE">
                                        <form name="form1" method="post" action="<%=path%>/StudentRZSave"
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td height="30" align="right"><span style="color:red;">*</span>楼栋：
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td height="30" align="right"><span style="color:red;">*</span>寝室：
                                                    </td>
                                                    <td>
                                                        <select name="Domitory_ID" id="Domitory_ID">
                                                            <option value="">请选择</option>
                                                            <%--                                            <s:iterator value="domitorylist">--%>
                                                            <%for (DomitoryBean dormitory : domitoryList) {%>
                                                            <option value="<%=dormitory.getDomitory_ID()%>">
                                                                <%=dormitory.getDomitory_Name()%>
                                                            </option>
                                                            <%}%>
                                                            <%--                                        </s:iterator>--%>
                                                        </select>
                                                ...
                                                <tr>
                                                    <td height="30" align="right"><span style="color:red;">*</span>学生学号：
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td height="30">&nbsp;</td>
                                                    <td><input type="submit" name="button" id="button" value="确定入住">
                                                    </td>
                                                </tr>
                                            </table>
                                        </form>
