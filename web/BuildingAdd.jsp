                    ...
                    <tr>
                        ...
                        <td width="709" align="center" valign="top" bgcolor="#F6F9FE">
                            <table width="709" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td height="30" background="Images/mainMenuBg.jpg" style="padding-left:25px;">添加楼栋
                                    </td>
                                </tr>
                                <tr>
                                    <td height="470" align="center" valign="top" bgcolor="#F6F9FE">
                                        <form name="form1" method="post" action="<%=path%>/BuildingAddSave"
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td height="30" align="right"><span style="color:red;">*</span>名称：
                                                    </td>
                                                    <td><input name="Building_Name" type="text" class="text2"
                                                               id="Building_Name"></td>
                                                </tr>
                                                <tr>
