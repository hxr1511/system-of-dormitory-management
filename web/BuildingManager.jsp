                    ...
                    <tr>
                        ...
                        <td width="709" align="center" valign="top" bgcolor="#F6F9FE">
                            <table width="709" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td height="30" background="Images/mainMenuBg.jpg" style="padding-left:25px;">楼栋管理
                                    </td>
                                </tr>
                                <tr>
                                    <td height="470" align="center" valign="top" bgcolor="#F6F9FE">
                                        <form name="form1" method="post" action="<%=path%>/BuildingManager">
                                            <table width="100%%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td width="28%" height="30" style="padding-left:20px;"> 功能导航： <a
                                                            href="BuildingAdd.jsp">添加楼栋</a></td>
                                                    <td width="72%">名称：
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr align="center">
                                                <td height="25" align="center"><%=building.getBuilding_Name()%>
                                                </td>
                                                <td><%=building.getBuilding_Introduction()%>
                                                </td>
                                                <td align="center">
                                                    <a href="<%=path%>/TBManager?Building_ID=<%=building.getBuilding_ID()%>">管理员</a>
                                                    <a href="BuildingUpdate.jsp?Building_ID=<%=building.getBuilding_ID()%>">修改</a>
                                                    <a href="<%=path%>/BuildingDel?Building_ID=<%=building.getBuilding_ID()%>"
