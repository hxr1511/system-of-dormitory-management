...
<%@ page import="com.gyk.Dao.DomitoryDao" %>
...
<%
    ...
    DomitoryBean domitory = new DomitoryDao().GetDomitoryId(Domitory_ID);
%>
                                ...
                                <tr>
                                    <td height="470" align="center" valign="top" bgcolor="#F6F9FE">
                                        <form
                                                ...
                                                action="<%=path%>/DomitoryUpdateSave?Domitory_ID=<%=domitory.getDomitory_ID()%>"
                                                onSubmit="return mycheck()">
                                            <table width="100%" border="0" cellspacing="0"
                                                   cellpadding="0">
                                                <tr>
                                                    <td width="33%" height="30" align="right">&nbsp;</td>
                                                    <td width="67%"><input name="Domitory_ID" type="text"
                                                                           class="noshow" id="Domitory_ID"
                                                                           value="<%=domitory.getDomitory_ID()%>"></td>
                                                </tr>
                                                <tr>
                                                    <td height="30" align="right"><span
                                                            style="color:red;">*</span>楼栋：
                                                    </td>
                                                    <td><select name="Domitory_BuildingID"
                                                        ...
                                                        <option value="<%=building.getBuilding_ID()%>"
                                                                <%if (domitory.getDomitory_BuildingID() == building.getBuilding_ID()) {%>
                                                                selected
                                                                <%}%>
                                                        >
                                                ...
                                                <tr>
                                                    <td height="30" align="right"><span
                                                            style="color:red;">*</span>寝室号：
                                                    </td>
                                                    <td><input name="Domitory_Name" type="text"
                                                               class="text2" id="Domitory_Name"
                                                               value="<%=domitory.getDomitory_Name()%>"></td>
                                                </tr>
                                                <tr>
                                                    <td height="30" align="right"><span
                                                            style="color:red;">*</span>寝室类型：
                                                    </td>
                                                    <td><input name="Domitory_Type" type="text"
                                                               class="text2" id="Domitory_Type"
                                                               value="<%=domitory.getDomitory_Type()%>"></td>
                                                </tr>
                                                <tr>
                                                    <td height="30" align="right"><span
                                                            style="color:red;">*</span>人数：
                                                    </td>
                                                    <td><input name="Domitory_Number" type="text"
                                                               class="text2" id="Domitory_Number"
                                                               value="<%=domitory.getDomitory_Number()%>"></td>
                                                </tr>
                                                <tr>
                                                    <td height="30">&nbsp;</td>
                                                    <td><input type="submit" name="button" id="button"
                                                               value="修改宿舍"> &nbsp;&nbsp; <input type="button"
                                                                                                 name="button2"
                                                                                                 id="button2"
                                                                                                 value="返回上页"
